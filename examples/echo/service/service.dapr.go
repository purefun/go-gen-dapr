...
func _Service_SomethingWrong_Handler(srv Service) InvocationHandlerFunc {
	return func(ctx context.Context, in *common.InvocationEvent) (out *common.Content, err error) {
		out = &common.Content{
			ContentType: "application/json",
		}
...
func RegisterService(s common.Service, srv Service) {
	...
	s.AddServiceInvocationHandler("SomethingWrong", _Service_SomethingWrong_Handler(srv))
}
